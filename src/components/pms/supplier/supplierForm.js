          ...
          <Grid container spacing={3}>
            <Grid item xs={6}>
              <TextField
                ...
                fullWidth
                defaultValue={
                  props.type === 'update' ? props.record.Supplier_Name : ''
                }
                type='search'
                name='Supplier_Name'
              ...
              {errors.Supplier_Name &&
                errors.Supplier_Name.type === 'required' && (
              ...
              {errors.Supplier_Name &&
                errors.Supplier_Name.type === 'maxLength' && (
            ...
            <Grid item xs={6}>
              <Autocomplete
                ...
                onChange={(event, value) => {
                  if (value != null)
                    setValue('Supplier_Type', value.Supplier_Type);
                }}
                style={{ marginBottom: '5px' }}
                renderInput={params => {
                  return (
            ...
            <Grid item xs={6}>
              <p
                style={{ color: '#ffffff', background: '#113C87' }}
                className='h6 text-left py-1'
              >
                {' '}
                Contact Info{' '}
              </p>
            ...
            <Grid item xs={4}>
              <TextField
                ...
                fullWidth
                defaultValue={
                  props.type === 'update' ? props.record.Address_Line1 : ''
                }
                type='search'
                name='Address_Line1'
                style={{ marginBottom: '5px' }}
              ...
              {errors.Address_Line1 &&
                errors.Address_Line1.type === 'maxLength' && (
                  <p className='form_error'> Maximum Length Allowed is 250 </p>
                )}
            </Grid>
            <Grid item xs={4}>
              <TextField
                ...
                fullWidth
                defaultValue={
                  props.type === 'update' ? props.record.Address_Line2 : ''
                }
                type='search'
                name='Address_Line2'
                style={{ marginBottom: '5px' }}
              ...
              {errors.Address_Line2 &&
                errors.Address_Line2.type === 'maxLength' && (
                  <p className='form_error'> Maximum Length Allowed is 250 </p>
                )}
            </Grid>
            <Grid item xs={2}>
              ...
              <Autocomplete
                ...
                defaultValue={
                  props.type === 'update'
                    ? country.find(
                        country =>
                          country.Country_ID === props.record.Country_ID
                      )
                    : {}
                }
            ...
            <Grid item xs={3}>
              <TextField
                ...
                fullWidth
                defaultValue={
                  props.type === 'update' ? props.record.Tel_NO1 : ''
                }
                type='search'
                name='Tel_NO1'
                style={{ marginBottom: '5px' }}
            ...
            <Grid item xs={3}>
              <TextField
                ...
                fullWidth
                defaultValue={
                  props.type === 'update' ? props.record.Tel_NO2 : ''
                }
                type='search'
                name='Tel_NO2'
                style={{ marginBottom: '5px' }}
            ...
            <Grid item xs={3}>
              <TextField
                ...
                fullWidth
                defaultValue={
                  props.type === 'update' ? props.record.Website : ''
                }
                type='search'
                name='Website'
                style={{ marginBottom: '5px' }}
            ...
            <Grid item xs={4}>
              <TextField
                ...
                fullWidth
                defaultValue={
                  props.type === 'update' ? props.record.Contact_Person : ''
                }
                type='search'
                name='Contact_Person'
                style={{ marginBottom: '5px' }}
            ...
            <Grid item xs={4}>
              <TextField
                ...
                defaultValue={
                  props.type === 'update'
                    ? props.record.Contact_Person_Mobile
                    : ''
                }
                type='search'
              ...
              {errors.Contact_Person_Mobile &&
                errors.Contact_Person_Mobile.type === 'required' && (
                  <p className='form_error'>
                    <i className='fas fa-exclamation-triangle'></i> This field
                    is required
                  </p>
              ...
              {errors.Contact_Person_Mobile &&
                errors.Contact_Person_Mobile.type === 'maxLength' && (
                  <p className='form_error'> Maximum Length Allowed is 250 </p>
                )}
            </Grid>
            <Grid item xs={4}>
              <TextField
                ...
                defaultValue={
                  props.type === 'update'
                    ? props.record.Contact_Person_Email
                    : ''
                }
                type='search'
              ...
              {errors.Contact_Person_Email &&
                errors.Contact_Person_Email.type === 'maxLength' && (
                  <p className='form_error'> Maximum Length Allowed is 250 </p>
                )}
            </Grid>
            ...
            <Grid item xs={3}>
              <TextField
                ...
                fullWidth
                defaultValue={
                  props.type === 'update' ? props.record.NTN_NO : ''
                }
                type='search'
                name='NTN_NO'
                style={{ marginBottom: '5px' }}
            ...
            <Grid item xs={3}>
              <TextField
                ...
                fullWidth
                defaultValue={
                  props.type === 'update' ? props.record.Sales_Tax_NO : ''
                }
                type='search'
                name='Sales_Tax_NO'
                style={{ marginBottom: '5px' }}
              ...
              {errors.Sales_Tax_NO &&
                errors.Sales_Tax_NO.type === 'maxLength' && (
                  <p className='form_error'> Maximum Length Allowed is 250 </p>
                )}
            </Grid>
            <Grid item xs={6}>
